...
Please refer to the link:https://github.com/verronpro/office-stamper/blob/main/intellij-style.xml[IntelliJ style configuration] for details.
...
* Return to the link:https://office-stamper.verron.pro/[Documentation Home]
* Check out the link:https://github.com/verronpro/office-stamper/issues[GitHub Issues] to find something to work on.

== Attribution

This guide is based on the link:https://github.com/bttger/contributing-gen[contributing-gen]. Make your own!
