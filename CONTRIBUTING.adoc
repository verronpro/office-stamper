...
If you want to ask a question, we assume that you have read the available https://office-stamper.verron.pro/[Documentation].
...
* Determine if your bug is really a bug and not an error on your side, e.g. using incompatible environment components/versions (Make sure that you have read the https://office-stamper.verron.pro/[documentation].
...
* Make sure that you are using the latest version.
* Read the https://office-stamper.verron.pro/[documentation] carefully and find out if the functionality is already covered, maybe by an individual configuration.
