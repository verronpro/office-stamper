...
https://github.com/verronpro/office-stamper/blob/master/CODE_OF_CONDUCT.md[Code of Conduct].
...
If you want to ask a question, we assume that you have read the available https://verronpro.github.io/office-stamper/[Documentation].

____

Before you ask a question, it is best to search for existing https://github.com/verronpro/office-stamper/issues[Issues] that might help you.
In case you have found a suitable issue and still need clarification, you can write your question in this issue.
It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

* Open an https://github.com/verronpro/office-stamper/issues/new[Issue].
...
* Determine if your bug is really a bug and not an error on your side, e.g. using incompatible environment components/versions (Make sure that you have read the https://verronpro.github.io/office-stamper/[documentation].
If you are looking for support, you might want to check <<I Have a Question,this section>>).
* To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the https://github.com/verronpro/office-stamperissues?q=label%3Abug[bug tracker].
...
* Make sure that you are using the latest version.
* Read the https://verronpro.github.io/office-stamper/[documentation] carefully and find out if the functionality is already covered, maybe by an individual configuration.
* Perform a https://github.com/verronpro/office-stamper/issues[search] to see if the enhancement has already been suggested.
...
Enhancement suggestions are tracked as https://github.com/verronpro/office-stamper/issues[GitHub issues].
