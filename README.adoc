...
void main(){
    ...
    var cfg = OfficeStamperConfigurations.standard()
        .setSecurityMode(SecurityMode.PERMISSIVE); // enable full SpEL capabilities for trusted templates

    // SVG safe mode (default: enabled)
    cfg.setSvgSafeModeEnabled(false); // relax parser hardening for trusted SVG inputs
}
