...
- **GraalVM Native CLI (Experimental)**: Ongoing work to provide a truly native executable with near-instant startup using GraalVM.
- **Improved Windows Integration**: Refined self-extracting portable EXE and installer profiles.
- **Enhanced Logging**: Better structured JSON logging and report generation.

== Navigation

* link:index.html[Back to Index]
* link:quickstart-windows.html[Quickstart (Windows)]
* link:https://office-stamper.verron.pro/engine/[Engine Documentation]

== Links

- Project homepage: https://github.com/verronpro/office-stamper
- Engine documentation: https://office-stamper.verron.pro/engine/
- Module site: https://office-stamper.verron.pro/cli/
