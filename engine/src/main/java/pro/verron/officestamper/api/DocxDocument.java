...
public interface DocxDocument {
    ...
    ///
    /// @param types the type of parts to stream, typically used to filter specific types of document parts
    ///
    /// @return a stream of [DocxPart] objects that match the specified types
