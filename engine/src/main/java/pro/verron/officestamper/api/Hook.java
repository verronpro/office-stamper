...
public interface Hook {
    /// Sets the context key associated with this hook. The context key is a unique identifier that can be used to match
    /// or scope the hook's execution within a specific [ContextTree] branch during document processing.
    ///
