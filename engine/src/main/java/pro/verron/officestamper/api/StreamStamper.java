...
/// executing of the stamp operation to an OfficeStamper instance while providing the necessary mechanisms to work with
/// streams.
///
...
public class StreamStamper<T extends OpcPackage> {
    ...
    ///
    /// This method first uses the loader to load the template from the InputStream into a type T instance, then uses
    /// the stamper to perform the stamp operation using the template and context, writing the result out to the
    /// OutputStream.
    ///
