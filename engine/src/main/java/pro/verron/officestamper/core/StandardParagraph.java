...
public class StandardParagraph implements pro.verron.officestamper.api.Paragraph {
    ...
    private StandardParagraph(Part part, Parent parent, ArrayListDocx4j<Object> p) {
        this.part = part;
        this.parent = parent;
        this.p = p;
    }
    ...
    public static StandardParagraph from(Part part, P paragraph) {
        return new StandardParagraph(part, new Paragraph(paragraph), (ArrayListDocx4j<Object>) paragraph.getContent());
    }
    ...
    /// @return a new instance of StandardParagraph constructed based on the provided source and paragraph.
    public static StandardParagraph from(Part part, Parent parent) {
        return new StandardParagraph(part, parent, (ArrayListDocx4j<Object>) parent.getContent());
    }
    ...
    public static StandardParagraph from(Part part, CTSdtContentRun paragraph) {
        ...
        return new StandardParagraph(part,
                new SdtContent(paragraph),
                (ArrayListDocx4j<Object>) parentParent.getContent()
        );
    }
    ...
    private String extractExpression(Object from, Object to) {
        ...
        Parent parent = () -> subContent;
        return new DocxIterator(parent).selectClass(R.class).map(WmlUtils::asString).collect(joining());
    }
    ...
    public Collection<Comments.Comment> getComment() {
        return CommentUtil.getCommentFor(() -> p, part.document().getPackage());
    }
