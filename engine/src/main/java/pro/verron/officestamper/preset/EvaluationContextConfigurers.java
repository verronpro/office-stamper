...
public class EvaluationContextConfigurers {
    ...
    ///
    /// This configurer does nothing to the StandardEvaluationContext class, and therefore all the unfiltered features
    ...
    ///
    /// The default configurer provides better default security for the [EvaluationContext] used by OfficeStamper. It
    ...
    /// This configurer is recommended to be used when there is a need for improved security and protection against
    ...
    ///
    /// The NoOpEvaluationContextConfigurer is a configuration placeholder used to indicate the intention to keep the
    /// standard powerful features provided by the Spring framework's StandardEvaluationContext class.
    ///
    /// StandardEvaluationContext is a powerful class by default, which can lead to potential security risks if not
    /// properly managed. This might include potential dangerous injections in the template.
    ///
    /// This configurer does nothing to the StandardEvaluationContext class, and therefore all the unfiltered features
    /// are accessible. It should be used when there is a need to use the powerful features of the aforementioned class,
    /// and there is a trust that the template won't contain any dangerous injections.
    ...
    /// [EvaluationContextConfigurer] that has better default security, especially doesn't allow especially known
    /// injections.
    ///
    /// @author Joseph Verron
    /// @version ${version}
