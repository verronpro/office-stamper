...
var configuration = OfficeStamperConfigurations.standard() .setSecurityMode(SecurityMode.PERMISSIVE);
...
var configuration = OfficeStamperConfigurations.standard() .setSvgSafeModeEnabled(false);
