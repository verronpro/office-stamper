...
The context object is a Java object that contains the data you want to insert into your document.
It can be:
...
| `Resolvers.image(true)`   | `pro.verron.officestamper.preset.Image` | an inline image (with deduplication)
...
You can create your own resolvers to handle specific types or formatting requirements.
See the link:custom-settings.html[Custom Settings] section for more information.
