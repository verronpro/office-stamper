...
@DisplayName("Image-related Features") class ImageTests
    ...
    @ParameterizedTest(name = "Null Pointer Resolution with Custom SpEL Configuration")
    private void nullPointerResolutionTest_testWithCustomSpel(ContextFactory factory) {
        ...
        testStamper(standard().setParserConfiguration(parserConfiguration)
