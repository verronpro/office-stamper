...
/// Utility class for rendering PptxDocument presentations to string representations.
///
/// This class provides methods to extract text content from PptxDocument files and convert them into formatted strings.
...
public class PptxRenderer {
    ...
    /// Converts the content of a PptxDocument presentation into a string by extracting text paragraphs from the
    /// presentation and formatting them as strings.
    ///
    /// @param presentation the PptxDocument presentation represented as a [PresentationMLPackage].
